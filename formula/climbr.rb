...
class Climbr < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/blazsolar/climbr-cli/releases/download/v0.3/climbr.tar.gz", :using => GitHubPrivateRepositoryReleaseDownloadStrategy
...
#    end
  ...
  test do
    assert_match "climbr 0.3", shell_output("#{bin}/climbr --version", 2)
  end
end